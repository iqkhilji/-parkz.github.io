...
<form class="box login" action="process-book-2.php" method="post">
	...
	<hr />
	   <label>Select suitable parking lot</label>
	...
	<hr />
	<label>**Free on first try**</label>
        <label>Pay with bkash(Registered user)</label>
        <li><a href="">BKASH</a></li>


        <label>Amount to be charged: BDT 150 /-(*Prices include app usage and VAT)</label>
	</fieldset>
	<footer>
